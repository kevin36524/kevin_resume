...
\item
\mysubheading{Senior Principal Software Apps Engineer}{(Nov 2023 onwards)}
\begin{itemize}
\vspace{-2pt}
\smalitem{\textbf{Innovation at Scale: Architecting, designing and implementing AI integrations and other non-AI features that push the boundaries of what's possible, ensuring they are both innovative and robust enough to handle our vast user base.}
\smalitem{\textbf{Collaborative Development: Working hand-in-glove with our brilliant Science, Design, Product and Backend teams, along with client-facing units, to bring groundbreaking new products to life within Yahoo Mail.}
\smalitem{\textbf{AI Optimization: Fine-tuning machine learning models and engaging in cutting-edge prompt engineering, all while prioritizing the security and privacy of user data – because trust is the cornerstone of user experience.}
\smalitem{\textbf{Integration & Rollout: Facilitating client-side integrations and spearheading feature rollouts to deliver a cohesive and responsive user interface.}
\end{itemize}
...
\item
\mysubheading{Director of Engineering for Yahoo Mail(iOS) }{(July 2022 - Nov 2023)}
\begin{itemize}
\vspace{-2pt}
